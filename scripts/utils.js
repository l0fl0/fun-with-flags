...
/**
 * Play audio file given URL or path
 * @param {string} filepath
 * @param {object} audioCtx An AudioContext object
 * @returns will play the audio file
 */
export async function playFile(filepath, audioCtx) {
